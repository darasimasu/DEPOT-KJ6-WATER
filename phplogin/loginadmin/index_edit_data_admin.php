...
function resetInput() {
    ...
    document.getElementById('namaInputSatu').value = '';
    document.getElementById('passwordInputSatu').value = '';
}
</script>

<script>
// Mendapatkan data admin dari server saat halaman dimuat
...
// function simpanDataAdmin() {
    ...
    // .then(response => response.json())
    // .then(data => {
    //     // Memperbarui status atau memberikan notifikasi jika diperlukan
        // console.log(data);
...
// function simpanDataAdmin() {
    ...
    // Menambahkan data hanya jika telah diubah
    // if (namaAdminSatu !== "") {
    //     formData.append('nama_admin_satu', namaAdminSatu);
    // }
    // if (passwordAdminSatu !== "") {
    //     formData.append('password_admin_satu', passwordAdminSatu);
    // }
    // if (namaAdminDua !== "") {
    //     formData.append('nama_admin_dua', namaAdminDua);
